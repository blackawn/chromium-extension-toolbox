...
<template>
  <div class="absolute top-4 right-4">
    ...
    >
      <div>
        <h6 class="mb-2 dark:text-neutral-500 text-sm space-y-1">
          General
        </h6>
      ...
      <div>
        ...
        <div class="flex items-center justify-between">
          <span class="text-base whitespace-nowrap">Edit General Website</span>
          <div class="flex items-center ml-6 py-1 px-1.5 space-x-2">
            <button
              type="button"
              class="text-xl dark:hover:text-neutral-400"
              :class="{ 'dark:text-neutral-600': !is.editGeneralWebsite }"
              @click="handleEditGeneralWebsite"
            >
            ...
            <button
              ...
              @click="generalStore.emptyGeneralWebSite()"
            >
        ...
        <div class="flex items-center justify-between">
          <span class="text-base whitespace-nowrap">Sort General Website</span>
          <div class="flex items-center ml-6 py-1 px-1.5 space-x-2">
            <button
              type="button"
              class="text-xl dark:hover:text-neutral-400"
              :class="( generalStore.sort === 'asc'?'dark:text-neutral-400':'dark:text-neutral-600' )"
              @click="generalStore.sortGeneralWebSiteByCount('asc')"
            >
            ...
            <button
              type="button"
              class="text-xl dark:hover:text-neutral-400"
              :class="( generalStore.sort === 'desc'?'dark:text-neutral-400':'dark:text-neutral-600' )"
              @click="generalStore.sortGeneralWebSiteByCount('desc')"
            >
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center ml-6 py-1 px-1.5 space-x-2">
            <button
              type="button"
              class="text-xl dark:hover:text-neutral-400"
              :class="( historyStore.sort === 'asc'?'dark:text-neutral-400':'dark:text-neutral-600' )"
            ...
            <button
              type="button"
              class="text-xl dark:hover:text-neutral-400"
              :class="( historyStore.sort === 'desc'?'dark:text-neutral-400':'dark:text-neutral-600' )"
