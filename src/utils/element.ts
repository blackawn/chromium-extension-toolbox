export const getElementPropertyValue =
    (element: HTMLElement, styleName: string | Array<string>): string | Array<object> | void => {
...
export const setElementPropertyValue =
    (element: HTMLElement, styleValue: Record<string, string>): void => {
